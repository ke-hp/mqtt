...
module.exports.authenticate = (client: any, username: any, password: any, callback: any) => {
...
module.exports.authorizePublish = (client: any, topic: any, payload: any, callback: any) => {
		let flag = false;
...
module.exports.authorizeSubscribe = (client: any, topic: any, callback: any) => {
		let flag = false;
